 ...
 * AFL风格的能量调度器实现
 */
public class AFLEnergyScheduler implements EnergyScheduler {
    ...
    public void updateEnergy(byte[] data, int executionTime, int newBranches) {
        if (!energyMap.containsKey(data)) {
            return;
        }
